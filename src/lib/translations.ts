...
export const NAV_TRANSLATIONS: Record<Language, Record<string, string>> = {
  pt: {
    ...
    // Almofadas Gallery Page
    "almofadas.hero.tag": "100% Personalizáveis",
    "almofadas.hero.title": "Almofadas Personalizadas",
    ...
    "almofadas.kit2": "Kit Sala Moderno",
    "almofadas.kit3": "Kit Sala Boho",
    "almofadas.kit4": "Kit Sala Natural",
    "almofadas.sofa.item": "Combinação para Sofá",
    "almofadas.cama.item": "Combinação para Cama",
    "almofadas.cta.tag": "Atendimento Personalizado",
    "almofadas.cta.title": "Monte a combinação perfeita para o seu ambiente",
    "almofadas.cta.desc": "Nossa especialista ajuda a escolher tecidos, estampas e tamanhos ideais para compor seus ambientes com personalidade.",
    "almofadas.cta.btn": "Solicitar Orçamento",
    "almofadas.cta.whatsapp": "Olá! Tenho interesse em almofadas personalizadas e gostaria de um orçamento.",
    ...
    // Timeline — Processo de Produção (Móveis)
    "process.label": "Como Funciona",
    "process.title": "Do projeto à realidade",
    "process.subtitle": "Cada detalhe pensado para você. Acompanhe as etapas do processo de criação dos seus móveis sob medida.",
    "process.step1.title": "Corte com Precisão",
    "process.step1.summary": "Cada painel cortado com exatidão milimétrica.",
    "process.step1.desc": "Utilizamos serras de alta precisão para garantir que cada peça saia com as dimensões exatas do projeto. Sem folgas, sem retrabalho.",
    "process.step1.b1": "Serra de precisão industrial",
    "process.step1.b2": "Cortes conforme projeto aprovado",
    "process.step1.b3": "Tolerância milimétrica em cada peça",
    "process.step2.title": "Modelagem e Acabamento das Bordas",
    "process.step2.summary": "Bordas trabalhadas à mão para um toque impecável.",
    "process.step2.desc": "Após o corte, cada peça tem suas bordas modeladas e lixadas manualmente. É nesse detalhe que se sente a diferença entre um móvel comum e um móvel de alto padrão.",
    "process.step2.b1": "Modelagem manual das bordas",
    "process.step2.b2": "Lixamento progressivo",
    "process.step2.b3": "Acabamento liso ao toque",
    "process.step3.title": "Pintura e Acabamento",
    "process.step3.summary": "Cada peça recebe camadas de laca com aplicação controlada.",
    "process.step3.desc": "A aplicação de laca garante superfície lisa, resistente e com cor uniforme. Um processo que exige precisão e ambiente controlado para um acabamento impecável.",
    "process.step3.b1": "Aplicação de laca em cabine fechada",
    "process.step3.b2": "Secagem e cura controladas",
    "process.step3.b3": "Acabamento liso e uniforme",
    "process.step4.title": "Corte de Precisão",
    "process.step4.summary": "Equipamentos de última geração para cortes com precisão absoluta.",
    "process.step4.desc": "Nossa fábrica conta com jato d'água CNC de alta potência para cortes em painéis, pedras e materiais nobres. Tolerância milimétrica garantida em cada peça produzida.",
    "process.step4.b1": "Jato d'água CNC DWJ4020",
    "process.step4.b2": "Corte em pedra, MDF e vidro",
    "process.step4.b3": "Tolerância de ±0,1 mm",
    "process.step5.title": "Polimento e Acabamento em Mármore",
    "process.step5.summary": "Superfície impecável, do bruto ao espelho.",
    "process.step5.desc": "Cada peça em mármore passa por etapas progressivas de polimento até atingir o brilho e a textura ideais. Um acabamento artesanal que realça as veias naturais da pedra.",
    "process.step5.b1": "Polimento progressivo em múltiplas etapas",
    "process.step5.b2": "Realce das veias naturais do mármore",
    "process.step5.b3": "Acabamento brilhante ou acetinado",
    "process.step6.title": "Estoque e Expedição",
    "process.step6.summary": "Produtos finalizados, organizados e prontos para sair.",
    "process.step6.desc": "Cada móvel concluído vai direto para o estoque, separado por projeto e aguardando a data de entrega combinada. Tudo controlado para que nada se perca no caminho.",
    "process.step6.b1": "Separação por projeto e ambiente",
    "process.step6.b2": "Controle de estoque por entrega",
    "process.step6.b3": "Transporte com veículo próprio",
    "process.step7.title": "Resultado Final",
    "process.step7.summary": "Do chão de fábrica ao ambiente dos seus sonhos.",
    "process.step7.desc": "O produto final instalado no seu espaço — exatamente como projetado. Cada detalhe entregue com o cuidado e a qualidade que você merece.",
    "process.step7.b1": "Design exclusivo por projeto",
    "process.step7.b2": "Acabamento de alto padrão",
    "process.step7.b3": "Garantia de satisfação",
  ...
  en: {
    ...
    "/papeis-de-parede/geometricos": "Geometric",
    "/papeis-de-parede/infantil": "Children's",
    "/papeis-de-parede/boho": "Boho",
    "/papeis-de-parede/natural": "Natural",
    "/papeis-de-parede/natureza": "Nature",
    "/tapetes": "Rugs",
    ...
    // Almofadas Gallery Page
    "almofadas.hero.tag": "100% Customisable",
    "almofadas.hero.title": "Custom Cushions",
    ...
    "almofadas.kit2": "Modern Living Room Kit",
    "almofadas.kit3": "Boho Living Room Kit",
    "almofadas.kit4": "Natural Living Room Kit",
    "almofadas.sofa.item": "Sofa Combination",
    "almofadas.cama.item": "Bed Combination",
    "almofadas.cta.tag": "Personalised Service",
    "almofadas.cta.title": "Build the perfect combination for your space",
    "almofadas.cta.desc": "Our specialist helps you choose the ideal fabrics, prints and sizes to compose your spaces with personality.",
    "almofadas.cta.btn": "Request a Quote",
    "almofadas.cta.whatsapp": "Hello! I'm interested in custom cushions and would like a quote.",
    ...
    // Timeline — Production Process (Furniture)
    "process.label": "How It Works",
    "process.title": "From project to reality",
    "process.subtitle": "Every detail thought out for you. Follow the steps of the creation process for your custom furniture.",
    "process.step1.title": "Precision Cutting",
    "process.step1.summary": "Every panel cut to millimetric precision.",
    "process.step1.desc": "We use high-precision saws to ensure every piece comes out with the exact dimensions of the project. No gaps, no rework.",
    "process.step1.b1": "Industrial precision saw",
    "process.step1.b2": "Cuts according to approved project",
    "process.step1.b3": "Millimetric tolerance on every piece",
    "process.step2.title": "Edge Shaping and Finishing",
    "process.step2.summary": "Edges hand-finished for an impeccable touch.",
    "process.step2.desc": "After cutting, every piece has its edges shaped and sanded by hand. This is where you feel the difference between an ordinary piece and high-end custom furniture.",
    "process.step2.b1": "Manual edge shaping",
    "process.step2.b2": "Progressive sanding",
    "process.step2.b3": "Smooth-to-the-touch finish",
    "process.step3.title": "Painting and Finishing",
    "process.step3.summary": "Each piece receives coats of lacquer with controlled application.",
    "process.step3.desc": "The lacquer application ensures a smooth, resistant and uniformly coloured surface. A process that demands precision and a controlled environment for an impeccable finish.",
    "process.step3.b1": "Lacquer application in enclosed cabin",
    "process.step3.b2": "Controlled drying and curing",
    "process.step3.b3": "Smooth, uniform finish",
    "process.step4.title": "Precision Cutting",
    "process.step4.summary": "State-of-the-art equipment for cuts with absolute precision.",
    "process.step4.desc": "Our factory uses a high-powered CNC waterjet for cuts in panels, stone and premium materials. Millimetric tolerance guaranteed on every piece produced.",
    "process.step4.b1": "CNC Waterjet DWJ4020",
    "process.step4.b2": "Cuts in stone, MDF and glass",
    "process.step4.b3": "Tolerance of ±0.1 mm",
    "process.step5.title": "Marble Polishing and Finishing",
    "process.step5.summary": "Impeccable surface, from rough to mirror-like.",
    "process.step5.desc": "Each marble piece goes through progressive polishing stages until the ideal shine and texture are achieved. A handcrafted finish that enhances the natural veins of the stone.",
    "process.step5.b1": "Progressive polishing in multiple stages",
    "process.step5.b2": "Enhancement of natural marble veins",
    "process.step5.b3": "Glossy or satin finish",
    "process.step6.title": "Stock and Dispatch",
    "process.step6.summary": "Finished, organised and ready to go.",
    "process.step6.desc": "Each completed piece of furniture goes directly to stock, separated by project and awaiting the agreed delivery date. Everything controlled so nothing gets lost along the way.",
    "process.step6.b1": "Separated by project and room",
    "process.step6.b2": "Stock control by delivery",
    "process.step6.b3": "Transport with own vehicle",
    "process.step7.title": "Final Result",
    "process.step7.summary": "From the factory floor to your dream space.",
    "process.step7.desc": "The finished product installed in your space — exactly as designed. Every detail delivered with the care and quality you deserve.",
    "process.step7.b1": "Exclusive design per project",
    "process.step7.b2": "Premium finish",
    "process.step7.b3": "Satisfaction guarantee",
    ...
    "gallery.tapetes.cta.whatsapp": "Hello! I'm interested in rugs and would like a personalised quote.",
  ...
  es: {
    ...
    "/papeis-de-parede/boho": "Boho",
    "/papeis-de-parede/natural": "Natural",
    "/papeis-de-parede/natureza": "Naturaleza",
    "/tapetes": "Alfombras",
    "/tapetes/moderno": "Moderno",
    "/tapetes/classico": "ClássicoS",
    "/tapetes/minimalista": "Minimalista",
    ...
    // Almofadas Gallery Page
    "almofadas.hero.tag": "100% Personalizables",
    "almofadas.hero.title": "Cojines Personalizados",
    ...
    "almofadas.kit2": "Kit Salón Moderno",
    "almofadas.kit3": "Kit Salón Boho",
    "almofadas.kit4": "Kit Salón Natural",
    "almofadas.sofa.item": "Combinación para Sofá",
    "almofadas.cama.item": "Combinación para Cama",
    "almofadas.cta.tag": "Atención Personalizada",
    "almofadas.cta.title": "Arme la combinación perfecta para su ambiente",
    "almofadas.cta.desc": "Nuestra especialista le ayuda a elegir telas, estampados y tamaños ideales para componer sus ambientes con personalidad.",
    "almofadas.cta.btn": "Solicitar Presupuesto",
    "almofadas.cta.whatsapp": "¡Hola! Estoy interesado/a en cojines personalizados y me gustaría un presupuesto.",
    ...
    // Línea de Tiempo — Proceso de Producción (Muebles)
    "process.label": "Cómo Funciona",
    "process.title": "Del proyecto a la realidad",
    "process.subtitle": "Cada detalle pensado para usted. Siga las etapas del proceso de creación de sus muebles a medida.",
    "process.step1.title": "Corte con Precisión",
    "process.step1.summary": "Cada panel cortado con exactitud milimétrica.",
    "process.step1.desc": "Utilizamos sierras de alta precisión para garantizar que cada pieza salga con las dimensiones exactas del proyecto. Sin holguras, sin retrabajos.",
    "process.step1.b1": "Sierra de precisión industrial",
    "process.step1.b2": "Cortes conforme al proyecto aprobado",
    "process.step1.b3": "Tolerancia milimétrica en cada pieza",
    "process.step2.title": "Modelado y Acabado de los Cantos",
    "process.step2.summary": "Cantos trabajados a mano para un tacto impecable.",
    "process.step2.desc": "Tras el corte, cada pieza tiene sus cantos modelados y lijados manualmente. Es en este detalle donde se siente la diferencia entre un mueble común y un mueble de alta gama.",
    "process.step2.b1": "Modelado manual de los cantos",
    "process.step2.b2": "Lijado progresivo",
    "process.step2.b3": "Acabado liso al tacto",
    "process.step3.title": "Pintura y Acabado",
    "process.step3.summary": "Cada pieza recibe capas de laca con aplicación controlada.",
    "process.step3.desc": "La aplicación de laca garantiza una superficie lisa, resistente y con color uniforme. Un proceso que exige precisión y un ambiente controlado para un acabado impecable.",
    "process.step3.b1": "Aplicación de laca en cabina cerrada",
    "process.step3.b2": "Secado y curado controlados",
    "process.step3.b3": "Acabado liso y uniforme",
    "process.step4.title": "Corte de Precisión",
    "process.step4.summary": "Equipos de última generación para cortes con precisión absoluta.",
    "process.step4.desc": "Nuestra fábrica cuenta con chorro de agua CNC de alta potencia para cortes en paneles, piedras y materiales nobles. Tolerancia milimétrica garantizada en cada pieza producida.",
    "process.step4.b1": "Chorro de agua CNC DWJ4020",
    "process.step4.b2": "Corte en piedra, MDF y vidrio",
    "process.step4.b3": "Tolerancia de ±0,1 mm",
    "process.step5.title": "Pulido y Acabado en Mármol",
    "process.step5.summary": "Superficie impecable, del bruto al espejo.",
    "process.step5.desc": "Cada pieza en mármol pasa por etapas progresivas de pulido hasta alcanzar el brillo y la textura ideales. Un acabado artesanal que realza las venas naturales de la piedra.",
    "process.step5.b1": "Pulido progresivo en múltiples etapas",
    "process.step5.b2": "Realce de las venas naturales del mármol",
    "process.step5.b3": "Acabado brillante o satinado",
    "process.step6.title": "Stock y Expedición",
    "process.step6.summary": "Productos finalizados, organizados y listos para salir.",
    "process.step6.desc": "Cada mueble concluido va directamente al stock, separado por proyecto y aguardando la fecha de entrega acordada. Todo controlado para que nada se pierda en el camino.",
    "process.step6.b1": "Separación por proyecto y ambiente",
    "process.step6.b2": "Control de stock por entrega",
    "process.step6.b3": "Transporte con vehículo propio",
    "process.step7.title": "Resultado Final",
    "process.step7.summary": "Del suelo de fábrica al ambiente de sus sueños.",
    "process.step7.desc": "El producto final instalado en su espacio — exactamente como fue proyectado. Cada detalle entregado con el cuidado y la calidad que usted merece.",
    "process.step7.b1": "Diseño exclusivo por proyecto",
    "process.step7.b2": "Acabado de alta gama",
    "process.step7.b3": "Garantía de satisfacción",
    ...
    "gallery.tapetes.cta.whatsapp": "¡Hola! Estoy interesado/a en alfombras y me gustaría un presupuesto personalizado.",
